...
=======
| [httpfs](/extensions/httpfs) | Read and write files over HTTP(s) protocol |
| [duckdb](/extensions/rdbms) | Scan data from an attached DuckDB database |
| [postgres](/extensions/rdbms) | Scan data from an attached PostgreSQL database |
