...
<LinkCard
    title="CREATE" href="/cypher/data-definition/create"
    description="Create statements in DDL"
/>
...
=======
    description="Alter statements in DDL"
>>>>>>> c5e8393 (Updates to DDL, map and struct data type docs (#203))
/>
...
=======
    description="Drop statements in DDL"
>>>>>>> c5e8393 (Updates to DDL, map and struct data type docs (#203))
/>
